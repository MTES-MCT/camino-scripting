...
let entreprisesAlias = require('../sources/json/entreprises-alias.json')
const slugify = require('@sindresorhus/slugify')

entreprisesAlias = Object.keys(entreprisesAlias).reduce((acc, nom) => ({...acc, [slugify(nom)]: entreprisesAlias[nom]}), {})
