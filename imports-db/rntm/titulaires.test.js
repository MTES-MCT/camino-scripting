...
describe('teste la gestion des titulaires', () => {
  each([
    ...
    ['Pennaroya',['PENARROYA']],
    ['Gewerkschaf',['Gewerkschaft']],
    ['MDPA-SA',['MDPA']],
    ['HEXAMINES GUILLIAMS',['HEXAMINES','GUILLIAMS']],
    ['Commune dePuy-Saint-André',['Commune de Puy-Saint-André']],

    ['COMPAGNIE DES MINES, FONDERIES ET FORGES D\'ALAIS'], ['COMPAGNIE DES MINES, FONDERIES ET FORGES D\'ALAIS'],
    ['COMPAGNIE DES MINES, FONDERIES ET FORGES D\'ALÈS'], ['COMPAGNIE DES MINES, FONDERIES ET FORGES D\'ALAIS'],
    ['COMPAGNIE DES MINES, FONDERIES ET FORGES DALAIS'], ['COMPAGNIE DES MINES, FONDERIES ET FORGES D\'ALAIS'],
    ['COMPAGNIE DES MINES ET FONDERIES ET FORGES D\'ALES'], ['COMPAGNIE DES MINES, FONDERIES ET FORGES D\'ALAIS'],

    ['COMPAGNIE DES MINES ET USINE DE SAINT MICHEL ET SORDIERE'], ['COMPAGNIE DES MINES ET USINES DE SAINT MICHEL ET SORDIERE'],
    ['COMPAGNIE DES MINES ET USINES DE SAINT MICHEL ET SORDIERE'], ['COMPAGNIE DES MINES ET USINES DE SAINT MICHEL ET SORDIERE'],
    ['COMPAGNIE DES MINES ET USINES DE SAINT MICHEL ET SORDIERES (LIQUIDATEUR FINAL : M. MAGNIN)'], ['COMPAGNIE DES MINES ET USINES DE SAINT MICHEL ET SORDIERE'],
    ['COMPAGNIE DES MINES ET USINES DE ST MICHEL ET SORDIERES (LIQUIDATEUR FINAL : M. MAGNINI)'], ['COMPAGNIE DES MINES ET USINES DE SAINT MICHEL ET SORDIERE'],

    ['COMPAGNIE DES MINES D\'ANTHRACITE ET DE TALC DU DAUPHINE (LIQUIDATEUR : M. PIERRE CRENN)'], ['COMPAGNIE DES MINES D\'ANTHRACITE ET DE TALC DU DAUPHINE'],
    ['COMPAGNIE DES MINES D\'ANTHRACITE ET DE TALC DU DAUPHINE POUR LES 2 TIERS'], ['COMPAGNIE DES MINES D\'ANTHRACITE ET DE TALC DU DAUPHINE'],
